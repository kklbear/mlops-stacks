...
# ``mlops_launchpad/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-mlops-launchpad-experiment",
...
dbutils.widgets.text(
    "model_name", "dev.ml_models.mlops-launchpad-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.ml_models.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.ml_models.trip_dropoff_features",
