...
git add README.md docs .gitignore mlops_launchpad/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. 
  ...
  [staging workspace admin console](https://dbc-e13694e8-bde7.cloud.databricks.com#setting/accounts) and
  [prod workspace admin console](https://dbc-2b58e21b-0638.cloud.databricks.com#setting/accounts). 
...
If you want to use different catalog names, please update the target names declared in the[mlops-launchpad/databricks.yml](../mlops_launchpad/databricks.yml) file.
...
Follow the instructions in [mlops-launchpad/resources/README.md](../mlops_launchpad/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../mlops_launchpad/resources/README.md)  to propose, test, and deploy
