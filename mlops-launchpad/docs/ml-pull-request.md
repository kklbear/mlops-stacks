...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops-launchpad-run-tests.yml) 
...
Links:
* [Staging model in UC](https://dbc-e13694e8-bde7.cloud.databricks.com/explore/data/models/staging/mlops-launchpad/mlops-launchpad-model)
* [Prod model in UC](https://dbc-2b58e21b-0638.cloud.databricks.com/explore/data/models/prod/mlops-launchpad/mlops-launchpad-model)
. 
